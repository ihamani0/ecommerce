        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <div class="form-body mt-4">
                    <form  id="myForm" method="post" action="{{route(App\Constants\Constants::Admin_Banner_UPDATE)}}"  enctype="multipart/form-data">
                        <input type="hidden" name="banner_uuid" value="{{$banner->banner_uuid}}">
                        @csrf
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="border border-3 p-4 rounded">
                                    ...
                                    <div class="mb-3 text-secondary " id="showImage">
                                        @if($banner->banner_image)
                                            <img src="{{\Illuminate\Support\Facades\Storage::url($banner->banner_image)}}"  class="rounded-1" width="200px" height="100px">
                                        @else
                                    ...
                                    <div class=" mb-3 text-secondary">
                                        <input type="submit" class="btn btn-outline-success px-4" value="Edit Banner" />
                                    </div>
