            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a href="{{route(\App\Constants\Constants::Admin_Order_INDEX)}}">
                            Orders View</a></li>
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            ...
                                            @else
                                                @switch($order->status)
                                                    @case('pending')
                                                    <div class="badge rounded-pill text-dark bg-light-cyne p-2 text-uppercase px-3">
                                                        {{ $order->status }}
                                                    </div>
                                                    @break
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            ...
                                            @else
                                                   ...
                                                   {{--     @case('delivered')
                                                        <a href="{{route(\App\Constants\Constants::Admin_Order_Change_Status ,
                                                            ['orderID' => $order->order_number , 'status' => 'confirm'])}}"
                                                           class="btn btn-outline-info">Confirmed Order</a>
                                                        @break--}}
                                                    @default
                                                    <p>N/A</p>
