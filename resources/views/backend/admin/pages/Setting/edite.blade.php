...
@section("admin")
    <div class="page-content">
        ...
        <form method="POST" action="{{route(\App\Constants\Constants::Admin_Setting_Update)}}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3 form-group">
                                ...
                                <input type="text" class="form-control" name="support_phone" id="inputProductTitle"
                                       value="{{$Setting->support_phone}}" placeholder="Enter product title" required="">
                            </div>
                            <div class="mb-3 form-group">
                                <label for="inputProductTitle" class="form-label">Address</label>
                                <input type="text" class="form-control" name="address"
                                       value="{{$Setting->address}}" id="inputProductTitle" placeholder="Enter product title" required="">
                            </div>
                            <div class="mb-3 form-group">
                                <label for="inputProductTitle" class="form-label">Email</label>
                                <input type="email" class="form-control" name="email" value="{{$Setting->email}}" id="inputProductTitle" placeholder="Enter product title" required="">
                            </div>
                            ...
                            <div class="mb-3 text-secondary " id="setImage">
                                @if($Setting->logo)
                                    <img height="100px" width="100px" src="{{\Illuminate\Support\Facades\Storage::url($Setting->logo)}}" >
                                @else
