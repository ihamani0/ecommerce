        ...
        <div class="card">
            <div class="card-body">
                <div class="form-body mt-4">
                    <form  id="myForm" method="post" action="{{route(App\Constants\Constants::Admin_Role_Update)}}"  enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="mb-3 form-group" >
                                    ...
                                    <input type="text" class="form-control" name="name" value="{{$role->name}}" id="inputProductTitle" placeholder="Enter product title" required>
                                </div>
                                <div class=" mb-3 text-secondary">
                                    <input type="submit" class="btn btn-outline-success px-4" value="Update Role" />
                                </div>
                            </div>
                        </div>
                    </form>
