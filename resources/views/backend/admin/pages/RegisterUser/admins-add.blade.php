        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <div class="form-body mt-4">
                    <form  id="myForm" method="post" action="{{route(App\Constants\Constants::Admin_Register_Admin_Store)}}"  enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="border border-3 p-4 rounded">
                                    ...
                                    <div class="mb-3 form-group" >
                                        <label for="inputProductTitle" class="form-label">Password<span class="text-danger">*</span></label>
                                        <input type="password" class="form-control" name="password" id="inputProductTitle" placeholder="Enter password" >
                                    </div>
                                    <div class="mb-3 form-group" >
                                        <label for="inputProductTitle" class="form-label">Confirm Password<span class="text-danger">*</span></label>
