            ...
            <div class="card-body p-4">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="form-body mt-4">
                        {{--Form--}}
                        <form id="MyForm" method="post" action="{{route(\App\Constants\Constants::Admin_Products_UPDATE)}}">
                            @csrf
                            <div class="row">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <div class="card-body p-4">
                    <div class="form-body mt-4">
                        {{--Form--}}
                        <form id="FormMainImg" method="post" action="{{route(\App\Constants\Constants::Admin_Products_UPDATE_Img)}}" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="product_uuid" value="{{$product->products_uuid}}">
                ...
                <div class="card-body p-4">
                    <div class="form-body mt-4">
                            <table class="table align-middle mb-0">
                                ...
                                <form id="MultipleImgForm" method="post" action="{{route(\App\Constants\Constants::Admin_Products_UPDATE_MultiImg)}}"
                                    ...
                                    @foreach($product->MultiplImg as $img )
                                            <tr>
                                                ...
                                                <td>
                                                        <input class="form-control mb-3 " type="file"  name="multiple_images[{{$img->id}}]" >
                                                </td>
                                                <td>
                                                    <div class="d-flex order-actions">
                                                        <a href="{{route(\App\Constants\Constants::Admin_Products_DESTORY_MultiImg , [$img->id , $product->products_uuid ])}}"
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <div class="card-body p-4">
                    <div class="form-body mt-4">
                        {{--Form--}}
                        <form  method="post" action="{{route(\App\Constants\Constants::Admin_Products_Add_MultiImg)}}" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="product_uuid" value="{{$product->products_uuid}}">
                            <input type="hidden" name="category_id" value="{{$product->category_id}}">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            $('#ProductCategory').on('change', function(){
                ...
                if (category_id) {
                    $.ajax({
                        url: "{{url("/api/admin/subcategory")}}/" + category_id,
                        type: "GET",
                        dataType: "json",
