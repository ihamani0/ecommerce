            ...
            <div class="card-body p-4">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="form-body mt-4">
                        {{--Form--}}
                        <form id="MyForm" method="post" action="{{route(\App\Constants\Constants::Admin_Products_STORE)}}" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-8">
                                    <div class="border border-3 p-4 rounded">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control visually-hidden"  name="product_size" data-role="tagsinput" value="XS,S,M,L,XL">
                                        </div>

                                        <div class="form-group mb-5">
                                            <label for="inputProductTitle" class="form-label">Product Color</label>
                                            <input type="text" class="form-control visually-hidden"  name="product_color" data-role="tagsinput" value="white,black,blue">
                                        </div>
                                        ...
                                        <div class="form-group mb-5">
                                            ...
                                            <textarea id="Long_desc" name="long_description">Hello, World!</textarea>
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <img  id="mainThmb" src="" alt="Image Preview" class="rounded mb-5" style="display: none;">
                                        </div>
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="form-group col-12">
                                                ...
                                                <select class="form-select" id="inputVendor" name="vendor_id">
                                                    <option disabled selected>Vendors</option>
