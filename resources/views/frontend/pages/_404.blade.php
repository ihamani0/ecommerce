            ...
            <div class="row">
                <div class="col-xl-8 col-lg-10 col-md-12 m-auto text-center">
                    ...
                    <p class="font-lg text-grey-700 mb-30">
                        ...
                        visit the <a href="{{route(\App\Constants\Constants::WELCOME)}}"> <span> Homepage</span></a> or
                        <a href="page-contact.html"><span>Contact us</span></a> about the problem
                    </p>
                    ...
                    <a class="btn btn-default submit-auto-width font-xs hover-up mt-30"
                       href="{{route(\App\Constants\Constants::WELCOME)}}"><i class="fi-rs-home mr-5"></i> Back To Home Page</a>
                </div>
            </div>
        </div>
    </div>
