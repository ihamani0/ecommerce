                ...
                <div class="col">
                    <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                        <div class="logo mb-30">
                            ...
                            <a href="{{route(\App\Constants\Constants::WELCOME)}}" class="mb-15">
                                <img src="{{\Illuminate\Support\Facades\Storage::url($Setting?->logo)}}" alt="logo" /></a>
                        ...
                        <ul class="contact-infor">
                            ...
                            <li><img src="{{asset("frontend/assets/imgs/theme/icons/icon-contact.svg")}}" alt="" /><strong>Call Us:</strong><span>(+213) {{$Setting?->support_phone}}</span></li>
    ...
    <div class="container pb-30 wow animate__animated animate__fadeInUp" data-wow-delay="0">
        <div class="row align-items-center">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <p class="font-sm mb-0">&copy; 2024, <strong class="text-brand">{{$Setting?->company_name}}</strong> - Awesome grocery store <br />All rights reserved</p>
            </div>
