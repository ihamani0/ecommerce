...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
         $Permissions = [
             //dashboard
             ['name' => 'view.dashboard', 'group' => 'dashboard', 'guard_name' => 'admin'],
             // Brand permissions
             ...
             ['name' => 'register.users', 'group' => 'user-management', 'guard_name' => 'admin'],
             ['name' => 'view.register-users', 'group' => 'user-management', 'guard_name' => 'admin'],
             ['name' => 'view.register-vendors', 'group' => 'user-management', 'guard_name' => 'admin'],
             ['name' => 'view.register-admins', 'group' => 'user-management', 'guard_name' => 'admin'],
