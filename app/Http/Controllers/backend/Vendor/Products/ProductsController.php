...
namespace App\Http\Controllers\backend\Vendor\Products;
...
class ProductsController extends Controller
{
    ...
    {
        return view("backend.vendor.pages.Product.index" , ['products'=> $this->product->getAllProducts()]);
    }
    ...
    {
        return view("backend.vendor.pages.Product.add" ,[
    ...
    public function store(ProductsRequest $request)
    {
        try {
            ...
            DB::commit();
            return redirect()->route(Constants::Vendor_Products_INDEX)->with(['success'=> "The Products add successfully"]);
    ...
    {
        return view("backend.vendor.pages.Product.edit" , [
    ...
    public function update(Request $request)
    {
        try {
            ...
            DB::commit();
            return redirect()->route(Constants::Vendor_Products_EDIT ,$request->product_uuid)->with(['success'=> "The Products Update successfully"]);
        }catch (\Exception $exception){
            DB::rollBack();
            return back()->with(['error' => $exception->getMessage()]);
        }
    ...
    public function updateMultiImg(Request $request)
    {
        ...
        try {
            $this->product->validateImgsExtns($request);
            DB::beginTransaction();
            $this->product->updateMultipleImgProduct($request);
            DB::commit();
            return redirect()->route(Constants::Vendor_Products_EDIT ,$request->product_uuid)->with(['success'=> "The Products Images Update successfully"]);
        }catch (\Exception $exception){
            DB::rollBack();
            return back()->with(['error' => $exception->getMessage()]);
        }
    ...
    public function destroy(string $uuid)
    {
        try {
            ...
            return redirect()->route(Constants::Vendor_Products_INDEX);
        } catch (Exception $e) {
            DB::rollBack();
    ...
    public function  destroyMultiImage(string $id , string $idProduct){
        try {
            ...
            DB::commit();
            toastr()->closeButton()->addWarning('The SubCategory deleted successfully');
            return redirect()->route(Constants::Vendor_Products_EDIT , $idProduct);
        } catch (Exception $e) {
            DB::rollBack();
    ...
    public function statusProduct($uuid){
        try {
            ...
            DB::commit();
            return redirect()->route(Constants::Vendor_Products_INDEX)->with(['success'=> 'The Status Change']);
        } catch (Exception $e) {
            DB::rollBack();
